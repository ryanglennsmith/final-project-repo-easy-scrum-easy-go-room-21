...
context('Course page', () => {
  ...
  //   cy.get(`.footerWrap`).contains('Copyright © 2022.')
  //     .get(`.MuiTypography-body2 > :nth-child(2)`).contains('WeShare All rights reserved.')
  //     .get(`.MuiTypography-root > img`).click()
  //     .url().should('include', '/');
  // });
  ...
  //   cy.get(`.aboutSectionBox > .MuiTypography-h4`).contains(`Why Learn With`)
  ...
  color: '#333'} `, () => {
    ...
    cy.get(`:nth-child(6) > .MuiTypography-h4`).contains(`About`)
    .should('have.css', "font-family", "lato")
    .and('have.css', "font-weight", "400")
    .and('have.css', "padding", '50px 0px 20px')
    .and('have.css', "color", "rgb(51, 51, 51)")
